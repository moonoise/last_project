                                ...
                                <form action="{{ route('step1.save') }}" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email"
                                            placeholder="กรอกอีเมล ในการใช้สมัคร" value="{{ old('email') }}">
                                    </div>
                                    <label for="exampleFormControlTextarea1"
                                        class="form-label">นโยบายการคุ้มครองข้อมูลส่วนบุคคล (Privacy Policy)</label>
                                    ...
                                    <div class="row justify-content-md-center">
                                        <div class="col-md-8 text-center">
                                            <button type="submit" class="btn btn-primary mt-3">ยินยอม / ไปต่อ</button>
                                        </div>
                                    </div>
                                    {{-- <button type="sumit" class="btn btn-primary">ต่อไป</button> --}}
                                </form>
                            </div>
                        </div>
                    </div>
